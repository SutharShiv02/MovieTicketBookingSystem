...
if(isset($_POST['add']))
{
    ...
    $sql_query = "INSERT INTO `theatre` (`owner_id`, `city`, `type`, `theatre_name`, `DOP`,`address`,`no_of_seats`) VALUES ('$owner_id', '$city', '$type', '$theatre_name',current_timestamp(),'$address','$seats');";
...
<body style="background-image : url('t2.jpeg'); background-size : cover; background-repeat : no-repeat;  backdrop-filter: blur(0px);">

    <div class="center">
        <h1 style = "color:rgb(51, 53, 69)">Add a Theatre</h1>
        <div class="failed">
            <span>
                <?php
                    if($flag==1)
        ...
        <form action="http://localhost/covid/provide_theatre.php" method="POST">
            ...
            <div class="text_field">
                <input type="text"  required name="theatre_name">
                <span></span>
