...
<body style="background :rgb(134 135 137)">
    ...
    border-radius: 7px;">
                ...
                <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
                    ...
                    <!-- <a class="mr-5 hover:text-gray-900" href="" style="color:white;">AboutUs</a>
                    <a class="mr-5 hover:text-gray-900" href="" style="color:white;">Blog</a> -->
                </nav>
    ...
    <div id="carouselExampleCaptions" class="carousel slide relative" data-bs-ride="carousel">
        ...
        <div class="carousel-inner relative w-full overflow-hidden">
            <div class="carousel-item active relative float-left w-full" style  = "background-size : cover; background-repeat : no-repeat;">
                <img src="http://localhost/covid/s4.jpg" class="block w-full" alt="..."
            ...
            <div class="carousel-item relative float-left w-full">
                <img src="http://localhost/covid/s5.jpeg" class="block w-full" alt="..."
                    style="height:450px" />
                <div class="carousel-caption hidden md:block absolute text-center">
            ...
            <div class="carousel-item relative float-left w-full">
                <img src="http://localhost/covid/s3.webp" class="block w-full" alt="..."
                    style="height:450px" />
                <div class="carousel-caption hidden md:block absolute text-center">
            ...
            <div class="carousel-item relative float-left w-full">
                <img src="http://localhost/covid/s1.jpeg" class="block w-full" alt="..."
                    style="height:450px" />
                <div class="carousel-caption hidden md:block absolute text-center">
                    <!-- <h5 class="text-xl">Third slide label</h5>
                    <p>Some representative placeholder content for the third slide.</p> -->
        ...
        <div class="flex justify-center">
            <div class="rounded-lg shadow-lg bg-white max-w-sm" style = "background:rgb(31, 37, 51)">
                <a href="\covid\owner_login.php">
                    <img class="rounded-t-lg" src="http://localhost/covid/o2.jpg" alt="" />
                </a>
        ...
        <div class="flex justify-center">
            <div class="rounded-lg shadow-lg bg-white max-w-sm" style = "background:rgb(31, 37, 51)">
                <a href="\covid\login_page.php">
                    <img class="rounded-t-lg" src="http://localhost/covid/o3.jpg" alt="" />
                </a>
                <div class="p-6" style = "display: flex;justify-content: center;" >
                    <!-- <h5 class="text-gray-900 text-xl font-medium mb-2">Card title</h5> -->
                    <!-- <p class="text-gray-700 text-base mb-4">
                    ...
                    <a href="\covid\login_page.php">
                    <button type="button"
                        class=" inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" style = "border-radius: 50px;background:rgb(134 135 137)">Customer Login</button>
                    </a>
                    </div>
            </div>
        </div>
