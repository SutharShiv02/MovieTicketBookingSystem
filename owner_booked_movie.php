...
$sql_query = "SELECT `movie`.`movie_name`,`book`.`customer_name`,`customer_signup`.`phone`,`theatre`.`theatre_name` FROM `theatre`,`book`,`customer_signup`,`movie` WHERE `theatre`.`owner_id`=$owner_id AND `theatre`.`t_id`=`book`.`t_id` AND `movie`.`m_id`=`book`.`m_id` AND `book`.`c_id`=`customer_signup`.`c_id`;";
...
<body>
    ...
    border-radius: 7px;">
        ...
        " aria-labelledby="dropdownMenuButton1">
              ...
              text-gray-700
              hover:bg-gray-100
            " href="/covid/provide_vehicle.php">Add a Theatre</a>
                                </li>
                                <li>
                                    <a class="
              dropdown-item
    ...
    <div class="flex"
        ...
        <div class="flex justify-center">
            <div class="rounded-lg shadow-lg bg-white max-w-sm">
                <?php
                    if(($row['movie_name']) == "pk")
                    {
                ?>
                <a href="#!">
                    <img class="rounded-t-lg" src="http://localhost/covid/pk.jpeg" alt="" />
                </a>
                <?php
                    }
                ?>
                <?php
                    if(($row['movie_name']) == "bahubali-2")
                    {
                ?>
                <a href="#!">
                    <img class="rounded-t-lg" src="http://localhost/covid/bahubali2.jpeg" alt="" />
                </a>
                <?php
                    }
                ?>
                <?php
                    if(($row['movie_name']) == "creta")
                    {
                ?>
                <a href="#!">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-700 text-base mb-4">
                        ...
                        Customer Phone : <?php echo ($row['phone'])?><br>
                        Theatre Name : <?php echo ($row['theatre_name'])?><br>
                    </p>
                </div>
            </div>
        </div>
